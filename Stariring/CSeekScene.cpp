...
CSeekScene::CSeekScene(GLint* _program, CCamera* _gameCamera, CActor* _gameActor, CTarget* _gameTarget, CInput* _gameInput)
{
	program = _program;
...
bool CSeekScene::Button(float width, float height, CMesh* buttonMesh)
{
